...
export default function Hero() {
  return (
    <section
      id="top"
      className="relative flex min-h-screen items-center overflow-hidden bg-grid-lines bg-grid pt-28 pb-20"
    >
      <div
        aria-hidden
        className="pointer-events-none absolute -top-32 left-1/2 h-[520px] w-[900px] -translate-x-1/2 rounded-full bg-signal/10 blur-[140px]"
      />
      <div className="relative mx-auto grid w-full max-w-6xl gap-16 px-5 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div>
          ...
          <motion.h1
            ...
            className="font-display text-4xl font-semibold leading-[1.08] text-text sm:text-5xl lg:text-[3.4rem]"
          >
          ...
          <motion.div
            ...
            className="mt-14 hidden items-center gap-2 font-mono text-xs text-text-faint sm:flex"
          >
